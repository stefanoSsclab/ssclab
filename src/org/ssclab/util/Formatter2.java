...
import org.ssclab.math.DoubleConsts;
import org.ssclab.math.FormattedFloatingDecimal;
 ...
 * @since 1.5
 */
public final class Formatter2 implements Closeable, Flushable {
    ...
    private Formatter2(Locale l, Appendable a) {
        this.a = a;
        this.l = l;
        this.zero = getZero(l);
    }

    private Formatter2(Charset charset, Locale l, File file)
     ...
     */
    public Formatter2(Appendable a) {
     ...
     *         is applied.
     */
    public Formatter2(Appendable a, Locale l) {
     ...
     *          creating the file
     */
    public Formatter2(String fileName) throws FileNotFoundException {
     ...
     */
    public Formatter2(String fileName, String csn)
     ...
     *          If the named charset is not supported
     */
    public Formatter2(String fileName, String csn, Locale l)
        throws FileNotFoundException, UnsupportedEncodingException
    {
     ...
     */
    public Formatter2(String fileName, Charset charset, Locale l) throws IOException {
     ...
     *          creating the file
     */
    public Formatter2(File file) throws FileNotFoundException {
        this(Locale.getDefault(Locale.Category.FORMAT),
     ...
     *          If the named charset is not supported
     */
    public Formatter2(File file, String csn)
        throws FileNotFoundException, UnsupportedEncodingException
    {
     ...
     *          If the named charset is not supported
     */
    public Formatter2(File file, String csn, Locale l)
        throws FileNotFoundException, UnsupportedEncodingException
    {
     ...
     */
    public Formatter2(File file, Charset charset, Locale l) throws IOException {
     ...
     */
    public Formatter2(PrintStream ps) {
        this(Locale.getDefault(Locale.Category.FORMAT),
     ...
     */
    public Formatter2(OutputStream os) {
        this(Locale.getDefault(Locale.Category.FORMAT),
     ...
     *          If the named charset is not supported
     */
    public Formatter2(OutputStream os, String csn)
        throws UnsupportedEncodingException
    {
     ...
     *          If the named charset is not supported
     */
    public Formatter2(OutputStream os, String csn, Locale l)
        throws UnsupportedEncodingException
    {
     ...
     */
    public Formatter2(OutputStream os, Charset charset, Locale l) {
     ...
     */
    public Formatter2 format(String format, Object ... args) {
     ...
     * @return  This formatter
     */
    public Formatter2 format(Locale l, String format, Object ... args) {
        ensureOpen();
    ...
    private class FormatSpecifier implements FormatString {
        ...
        private void printString(Object arg, Locale l) throws IOException {
            ...
            if (arg instanceof Formattable) {
            	...
            	//CAMBIATO PESANTEMENTE
            	java.util.Formatter fmt = new java.util.Formatter(Formatter2.this.out());
                if (fmt.locale() != l) {
                    fmt = new java.util.Formatter(Formatter2.this.out(), l);
        ...
        /*
        private void printString2(Object arg, Locale l) throws IOException {
            if (arg instanceof Formattable) {
                Formatter fmt = Formatter.this;
                if (fmt.locale() != l)
